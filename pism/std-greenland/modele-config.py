...
env['CMAKE_PREFIX_PATH'] = ":".join(cmdlist("""
    ...
    /home2/rpfische/spack5/opt/spack/linux-centos7-x86_64/gcc-4.9.3/icebin-develop-3aj3gxhfo272k5p34ivy4quia75ts2cm
...
env['SPACK_TRANSITIVE_INCLUDE_PATH'] = ";".join(cmdlist("""
    ...
    /home2/rpfische/spack5/opt/spack/linux-centos7-x86_64/gcc-4.9.3/icebin-develop-3aj3gxhfo272k5p34ivy4quia75ts2cm/include
