...
# Run the main test.
all: test_diagonal.png test_elevation.png sr_g20_searise.pdf modele_ll_g2hx2.pdf modele_ll_g2hx2-sr_g20_searise.pdf matrices.pik GIC.144X90.DEC01.1.ext_1-fhc.nc Z2HX2fromZ1QX1N-fhc.nc
...
modele_ll_g2hx2.nc :
	echo '*****************************************************************'
	echo '[makefile] Generating modele_ll_g2hx2.nc: ModelE Atmosphere Grid'
	modele_ll --zone g

# Overlap two grids
modele_ll_g2hx2-sr_g20_searise.nc : modele_ll_g2hx2.nc sr_g20_searise.nc
	echo '*****************************************************************'
	echo '[makefile] Overlapping ModelE and SeaRISE Grids'
	overlap modele_ll_g2hx2.nc sr_g20_searise.nc

pismsheet_g20_icebin_in.nc : modele_ll_g2hx2-sr_g20_searise.nc pismsheet_elev_mask.nc
	echo '*****************************************************************'
	echo '[makefile] Assembling IceBin Input File from grids.'
	$(PYTHON3) write_icebin_in_base.py . modele_ll_g2hx2 sr_g20_searise pismsheet_elev_mask.nc ./pismsheet_g20_icebin_in.nc
...
# =============== ModelE Input Files
GIC.144X90.DEC01.1.ext_1-fhc.nc Z2HX2fromZ1QX1N-fhc.nc : pismsheet_g20_icebin_in.nc
	$(PYTHON3) add_fhc.py --stieglitz --elev-mask-type mar --topo-leaf Z2HX2fromZ1QX1N --gic-leaf GIC.144X90.DEC01.1.ext_1 --icebin-in ./pismsheet_g20_icebin_in.nc --elev-mask ./pismsheet_elev_mask.nc
...
modele_ll_g2hx2.pdf : modele_ll_g2hx2.nc
	echo '*****************************************************************'
	echo '[makefile] Plotting grid outlines for ModelE Grid'
	$(PYTHON3) plot_grid_outlines.py modele_ll_g2hx2 grid

modele_ll_g2hx2-sr_g20_searise.pdf : modele_ll_g2hx2-sr_g20_searise.nc
	echo '*****************************************************************'
	echo '[makefile] Plotting grid outlines for Exchange Grid'
	$(PYTHON3) plot_grid_outlines.py modele_ll_g2hx2-sr_g20_searise exgrid
